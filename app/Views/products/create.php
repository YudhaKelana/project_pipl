                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="<?= base_url('product/store') ?>" method="post">
                            ...
                            <!-- INPUT BATAS STOK MENIPIS (THRESHOLD) -->
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="low_stock_threshold" class="form-control border-start-0 ps-0" placeholder="5" value="<?= old('low_stock_threshold', 5) ?>" min="1" required>
                                </div>
